...
{
	/**
	 * Called by {@link no.runsafe.framework.minecraft.player.RunsafePlayer#canSee(no.runsafe.framework.minecraft.player.RunsafePlayer)} to test if a player should be aware of someone else or not
	 */
