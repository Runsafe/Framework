...
public class PortalEvent extends EventRouterBase<IEntityPortalEvent, EntityPortalEvent>
{
	PortalEvent(IConsole output, IScheduler scheduler, IEntityPortalEvent handler)
	{
	...
	public static EventRouterFactory Factory()
	{
		return new EventRouterFactory()
		{
			...
			{
				return new PortalEvent(output, scheduler, (IEntityPortalEvent) subscriber);
			}
		};
	}
}
