...
public abstract class AsyncCallbackCommand<T> extends ExecutableCommand
{
	...
	/**
	 * Called on the main thread before {@link AsyncCallbackCommand#OnAsyncExecute(no.runsafe.framework.server.ICommandExecutor, java.util.HashMap)}
	 *
	...
	/**
	 * This method gets called on the main thread after the {@link AsyncCallbackCommand#OnAsyncExecute(no.runsafe.framework.server.ICommandExecutor, java.util.HashMap)} completes
	 *
