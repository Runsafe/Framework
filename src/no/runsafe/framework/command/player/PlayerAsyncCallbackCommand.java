...
public abstract class PlayerAsyncCallbackCommand<T> extends AsyncCallbackCommand<T>
{
	...
	/**
	 * This method is called on the main thread before {@link PlayerAsyncCallbackCommand#OnAsyncExecute(no.runsafe.framework.server.ICommandExecutor, java.util.HashMap)}
