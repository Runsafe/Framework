...
{
	/**
	 * Called by {@link no.runsafe.framework.minecraft.player.RunsafePlayer#lastLogout()} on behalf of plugins that
	 * want to find out when a player left the server
	 */
	DateTime GetPlayerLogout(RunsafePlayer player);

	/**
	 * Called by {@link no.runsafe.framework.minecraft.player.RunsafePlayer#getBanReason()} on behalf of plugins that
	 * want to know why a player was banned
	 */
	String GetPlayerBanReason(RunsafePlayer player);

	/**
	 * Called by {@link no.runsafe.framework.minecraft.player.RunsafePlayer#isNew()} on behalf of plugins that want to
