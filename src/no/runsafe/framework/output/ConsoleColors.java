...
public class ConsoleColors
{
	...
	public static final String YELLOW = Rendition.Clear().Foreground(Colour.Yellow).toString();
	public static final String WHITE = Rendition.Clear().Bright().Foreground(Colour.White).toString();
	public static final String MAGIC = Rendition.Clear().Reverse().Underline().toString();
